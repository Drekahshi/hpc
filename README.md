...
- 📄 **[Full README](./DOCSand%20PLAYGROUND%20CODE/README.md)**: Project overview and setup.
- 📘 **[Whitepaper](./DOCSand%20PLAYGROUND%20CODE/docs/HisaWhitepaper.md)**: Detailed vision and technical architecture.
- 🛠️ **[Backend Spec](./DOCSand%20PLAYGROUND%20CODE/docs/HISA_BACKEND_BUILD_SPEC.md)**: Technical implementation details.
- 🎤 **[Pitch Notes](./DOCSand%20PLAYGROUND%20CODE/docs/PITCH_NOTES.md)**: Submission-ready content and pitch overview.
...
1. Navigate to the `hisa-backend` directory.
2. Install dependencies: `npm install`.
3. Configure your `.env` file (refer to `.env.example`).
4. Run the development server: `npm start`.

---
*HISA People Chain · [github.com/Drekahshi/HISA--CHAIN](https://github.com/Drekahshi/HISA--CHAIN) · Hedera Testnet · EPRA Hackathon 2025 · Kenya*
